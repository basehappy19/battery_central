...
export const DEFAULT_SETTINGS: Record<string, string> = {
  ...
  msg_template_full_charge: 'ชาร์จเต็ม 100% เรียบร้อยแล้ว',
  msg_template_near_full: 'ชาร์จถึงระดับแจ้งเตือน ({battery}%)',
  msg_template_low_battery: 'ลดต่ำกว่าจุดแจ้งเตือน ({battery}%)',
  msg_template_battery_empty: 'แบตเตอรี่เหลือ 0%',
  msg_template_reconnected: 'กลับมาออนไลน์',
